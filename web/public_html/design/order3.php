<?
$_SUB_HEAD_TITLE = "포장 주문하기"; //헤더에 타이틀명이 없을경우 공백
    ...
    <div class="sub_pg pb_lg">
        <div class="container shop_hd">
            <div class="d-flex  align-items-center ">
                <div class="mr-2">
                    <p> <span class="badg green"><span class="ic_img ic_pack mr-2"></span>포장</span></p>
                    <a href="./shop2.php">
        ...
        <div class="bottom_btn  ">
            <div class="form-row">
                <div class="col-12"><button type="button" class="btn btn-primary btn-block btn-lg " onclick="location.href='./order3_cmp.php'">24,000원 결제하기 </button></div>
            </div>
        </div>
    </div>
</div>
