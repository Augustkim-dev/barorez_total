            ...
            <div class="card   ">
                <div class="card-header">
                    <div class="d-flex  align-items-center ">
                        <div class="mr-2">
                            <p class="d-flex align-items-center"><span class="badg green"><span class="ic_img ic_pack mr-2"></span>포장</span> <span class="t_green ml-3">포장 요청</span></p> <a href="./shop.php">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body mt-5">
                <div class="no_data  ">
                    ...
                    <p class="   line_h1_4 mt-3 fs_18 fw_600">포장 취소 하시겠습니까?</p>
                </div>
            </div>
            <div class="modal-footer">
                <div class="form-row justify-content-end">
                    <div class="col-4"><button type="button" class="btn btn-outline-light btn-block  " data-dismiss="modal">아니요</button></div>
                    <div class="col-8"><button type="button" class="btn btn-primary btn-block" data-dismiss="modal">포장 취소</button></div>
                </div>
            </div>
        </div>
    </div>
