<div class="hd_m align-items-center justify-content-between">
	<a class="d-flex flex-fill align-items-center" href="./">
		<img class="flex-shrink-0 logo_img" src="./img/logo.svg">
	</a>
	<div class=" justify-content-end d-flex align-items-center">

		<!-- 장바구니 버튼
		 <button class="hd_btn mr-4" type="button" onclick="location.href='./cart.php'">
			<img src="./img/icon_cart.png" alt="장바구니">
			<span></span>
		</button> -->

		 <a href="" class="badg  green mr-3" onclick="location.href='./order_history.php'">
		...
		<!-- 로그인버튼-->
		<!-- <button type="button" class="btn btn-secondary btn-sm rounded-pill"  onclick="location.href='./login.php' ">로그인</button> -->
	</div>
</div>