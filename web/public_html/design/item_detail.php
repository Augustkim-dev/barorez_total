...
<!--메뉴담기를 누르면 장바구니가 아닌 메인홈(C-2a 메인 홈 )으로 이동 / 하단에 장바구니 버튼이나옴-->
    <div class="bottom_btn  ">
        <div class="form-row">
            <div class="col-12"><button type="button" class="btn btn-primary btn-block btn-lg" onclick="location.href='./cart.php'">24,000원 담기 </button></div>
        </div>
    </div>
</div>
