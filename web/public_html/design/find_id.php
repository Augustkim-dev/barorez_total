        ...
        <div class="container">
			<form>
				<div class="form_wr mt-5 ip_invalid">
						...
						<div class="form-row">
							<div class="col">
								<input type="password" class="form-control" placeholder="이름 입력">
							</div>
						</div>
					...
					<div class="bottom_btn  ">
						<div class="form-row">
							<div class="col-12"><button type="button" class="btn btn-primary btn-block  btn-lg" onclick="location.href='./find_id_cmp.php'">아이디 찾기</button></div>
						</div>
					</div>
			</form>
        </div>
