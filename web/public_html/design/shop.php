	...
	<div class=" idx_pg  ">
		<div class="container shop_hd">
			...
			<div class="ck_btn_group">
				<button type="button" class="btn btn-outline-primary btn-md  btn-block ">예약</button>
				<button type="button" class="btn   btn-md btn-block mt-0"  onclick="location.href='./shop2.php' ">포장</button>
			</div>
			<div class="mt-4">
		...
		<ul class="item_list">
			<li>
				<div class="item_box  ">
					...
					<a class="item_link" href="./item_detail2.php"></a>
				</div>
			</li>
			<li>
				<div class="item_box  ">
		...
		<div class="bottom_btn  ">
			<div class="form-row">
				<div class="col-12"><button type="button" class="btn btn-primary btn-block btn-lg  " onclick="location.href='./cart2.php'">장바구니 <span class="badge bg-white  text-primary rounded-pill ml-2">3</span></button></div>
			</div>
		</div>

		<!-- 예약과 포장이 둘다 가능한 매장은 예약이 기본-->
		<div class="bottom_btn  ">
			<div class="form-row">
				<div class="col-12"><button type="button" class="btn btn-primary btn-block  btn-lg " onclick="location.href='./rsrv.php'">즉시 예약 </button></div>
			</div>
		</div>
