    ...
    <div class="sub_pg pb_lg">
        <div class="container shop_hd">
            <div class="d-flex  align-items-center ">
                <div class="mr-2">
                    <p><span class="badg"><span class="ic_img ic_qr mr-2"></span>QR주문</span></p>
                    <a href="./index.php">
        ...
        <div class="bottom_btn  ">
            <div class="form-row">
                <div class="col-12"><button type="button" class="btn btn-primary btn-block btn-lg " onclick="location.href='./order_cmp.php'">24,000원 결제하기 </button></div>
            </div>
        </div>
    </div>
</div>
