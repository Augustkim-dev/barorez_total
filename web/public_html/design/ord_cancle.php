<?
$_SUB_HEAD_TITLE = "취소 상세"; //헤더에 타이틀명이 없을경우 공백
...
<div class="wrap">
    <div class="sub_pg ">
            ...
            <div class="card   ">
                <div class="card-header">
                    <div class="d-flex  align-items-center ">
                        <div class="mr-2">
                            <p class="d-flex align-items-center"><span class="badg blue"><span class="ic_img ic_calendar mr-2"></span>예약</span> <span class="text-danger ml-3">예약 취소</span></p>
                            <a href="./shop.php">
        ...
        <!--  선결제 아니고 바로 예약일때는 아래쪽 주문 메뉴가 안들어감-->
