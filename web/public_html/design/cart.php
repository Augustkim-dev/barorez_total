...
<div class="wrap">
    <div class="sub_pg pb_lg">
        ...
        <div class="container my-3">
            <button type="button" class="btn btn-outline-primary btn-block btn_st1" onclick="location.href='./item_detail.php'">메뉴 추가 <img src="./img/btn_deco.svg" alt=" " class="ml-3"></button>
        </div>
        <div class="bar">
        </div>
        ...
        <div class="bottom_btn  ">
            <div class="form-row">
                <div class="col-12"><button type="button" class="btn btn-primary btn-block btn-lg" onclick="location.href='./order.php'">총 2개 41,000원 <span class="fw_100 mx-3">|</span> 주문하기</button></div>
            </div>
        </div>
    </div>
</div>
