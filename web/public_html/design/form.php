<?
$_SUB_HEAD_TITLE = "폼"; //헤더에 타이틀명이 없을경우 공백
...
<div class="wrap">
	<div class="sub_pg">
		<div class="container position-relative">
			...
			<div class="tit_h1">1. 타이틀용서체 Pretendard-Bold 22px</div>
			<h1 class="mb-3 mt-5 fs_16">▼ 타이틀 스타일2</h1>
			<div class="tit_h2">2. 타이틀용서체 Pretendard-Bold 20px</div>
			<h1 class="mb-3 mt-5 fs_16">▼ 타이틀 스타일3</h1>
			<div class="tit_h3">3. 타이틀용서체 Pretendard-Bold 19px</div>
			<h1 class="mb-3 mt-5 fs_16">▼ 타이틀 스타일4</h1>
			<div class="tit_h4">4. Pretendard-SemiBold 18px</div>
			<h1 class="mb-3 mt-5 fs_16">▼ 타이틀 스타일5</h1>
			<div class="tit_h5">5. Pretendard-Bold 15px</div>
			<h1 class="mb-3 mt-5 fs_16">▼ 타이틀 스타일6</h1>
			<div class="tit_h6">6. Pretendard-SemiBold 15px</div>
			...
			<div class="btn-group btn-group-toggle btn-group-full" data-toggle="buttons">
				<label class="btn btn-outline-light rounded-sm active">
					<input type="radio" name="options" id="option1" checked> Radio
				</label>
				<label class="btn btn-outline-light rounded-sm">
			...
			<h1 class="mb-4 mt-5 fs_16">▼ 버튼 슬라이드 .btn-outline-light 은 검은버튼</h1>
			<!-- 카테고리 -->
			...
			<nav class="mb_20">
				<ul class="nav nav-pills row" id="nav-tab" role="tablist">
					<li class="col">
						<button class="nav-link btn btn-block active" id="tab02_tab1" data-toggle="tab" data-target="#tab02_1" type="button" role="tab" aria-selected="true">탭02_1</button>
					</li>
					<li class="col">
						<button class="nav-link btn btn-block" id="tab02_tab2" data-toggle="tab" data-target="#tab02_2" type="button" role="tab" aria-selected="false">탭02_2</button>
					</li>
					<li class="col">
						<button class="nav-link btn btn-block" id="tab02_tab3" data-toggle="tab" data-target="#tab02_3" type="button" role="tab" aria-selected="false">탭02_3</button>
					</li>
					<li class="col">
						<button class="nav-link btn btn-block" id="tab02_tab4" data-toggle="tab" data-target="#tab02_4" type="button" role="tab" aria-selected="false">탭02_4</button>
					</li>
				</ul>
			</nav>
			...
			<div class="">
				...
				<div class="form_wr mt-5">
					...
					<div class="form-row">
						...
						<div class="col-3 col-lg-2">
							<button type="button" class="btn btn-outline-light btn-block text-body">인증요청</button>
						</div>
					</div>
				</div>
				...
				<div class="form_wr mt-5">
					...
					<div class="scroll_mouse scroll_bar_none">
						<div class="d-flex">
				...
				<div class="form_wr mt_20">
					...
					<div class="scroll_mouse scroll_bar_none mb_16">
						<div class="d-flex">
							<div class="image_upload on">
								<input id="ip_file" type="file" class="d-none">
								<label for="ip_file" class="upload_box">
					...
					<button type="button" class="btn btn-light btn-block">
						<img class="mr-2" src="./img/file_up.png" style="width:2.4rem;"><span class="text-black fs_14">이미지 업로드</span>
					</button>
				</div>
			...
			<div class="d-flex" style="height:30rem;">
				<div class="no_data flex-fill">
					<div class="mb-3"><img src="./img/no_data.png" style="width:10rem;"></div>
					<p class="fs_16 text-center text-gray3 line_h1_4">현재 결제 가능한 주문이 없습니다.<br>장바구니를 확인해주세요</p>
				</div>
			</div>
			<div class="no_data  ">
				...
				<ul>
					<li id="collapse_hd01">
						<button type="button" class="btn btn-link btn-sm" data-toggle="collapse" data-target="#collapse01" aria-expanded="false" aria-controls="collapse01">
							...
							<img src="./img/ico_open.png" style="width:2.0rem;">
						</button>
			...
			<div class="mb-4">
				<form class="sch_ip border align-items-center">
					...
					<button class="btn btn-icon flex-shrink-0"><img src="./img/ic_ip_sch.png" style="width:2.0rem;"></button>
				</form>
			</div>
			...
			<h1 class="mb-3 mt-5 fs_16">▼ 뱃지</h1>

			<div class="mb-4">
				<span class="badg"><span class="ic_img ic_qr mr-2"></span>QR주문</span>
				<span class="badg blue"><span class="ic_img ic_calendar mr-2"></span>예약</span>
				<span class="badg green"><span class="ic_img ic_pack mr-2"></span>포장</span>
			</div>


			<div>
				<h1 class="mb-3 mt-5 fs_16">▼ btn-alert 스크립트는 custom.js 에 있음</h1>
				<button class="btn btn-primary btn-alert" data-message="경고 메시지입니다!">
					a 버튼
				</button>

				<button class="btn btn-success btn-alert" data-message="성공적으로 처리되었습니다!">
					b 버튼
				</button>

				<!-- Alert들이 쌓여 나타날 컨테이너 -->
				<div id="alertContainer" style="position:fixed; top:20px; right:20px; width:300px; z-index:1080;"></div>
