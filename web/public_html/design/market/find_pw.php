...
<div class="sub_pg pl-0 ">
    <div class="join_form_wr">
        <div class="hd_tit">
            <h2 class="tit_st1 d-flex align-items-center"><a href="#" onclick="history.back(); return false;" class="mr-4 line_h0 "><img src="./img/ico_back.svg" alt=" 뒤로가기"></a><span>비밀번호 찾기</span></h2>
        </div>
        <div class="join_form">
            <div class="join_box">
                ...
                <button type="button" class="btn btn-primary btn-lg btn-block"  onclick="location.href='./find_pw_reset.php'">확인</button>
            </div>
            </div>
        </div>
    </div>
