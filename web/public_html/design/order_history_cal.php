...
<div class="wrap">
    <div class="sub_pg bg-light">
        <ul class="nav nav_tab_line">
            <li class="nav-item">
                <button class="nav-link " onclick="location.href='./order_history.php ' ">주문 내역</button>
            </li>
            <li class="nav-item">
                <button class="nav-link active"  >취소 내역</button>
            </li>
        </ul>
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex  align-items-center ">
                        <div class="mr-2">
                            <p class="d-flex align-items-center"><span class="badg blue"><span class="ic_img ic_calendar mr-2"></span>예약</span> <span class="text-danger ml-3">예약취소</span></p>
                            <a href="./ord_cancle.php" class="d-flex align-items-center mt-2">
                        ...
                        <div class="ml-auto ">
                            <div class="item_img ">
                                <a href="./ord_cancle.php" class="d-block">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex  align-items-center ">
                        <div class="mr-2">
                            <p class="d-flex align-items-center"><span class="badg green"><span class="ic_img ic_pack mr-2"></span>포장</span> <span class="text-danger ml-3">포장 취소</span></p>
                            <a href="./ord_cancle.php" class="d-flex align-items-center mt-2">
                                <p class="fs_18 fw_700  line1_text">바다마을 해물칼국수 [성수점]</p>
                                <img src="./img/ico_arrow1.png" alt="내정보 수정" class="ml-3 flex-shrink-0" style="width: 2rem;">
                            </a>
