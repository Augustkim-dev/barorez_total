<?
$_SUB_HEAD_TITLE = "비밀번호 재설정"; //헤더에 타이틀명이 없을경우 공백
        ...
        <div class="container">
			<form>
				<div class="form_wr mt-5 ip_invalid">
						...
						<div class="form-row">
							<div class="col-12">
								<input type="password" class="form-control" placeholder="새 비밀번호  입력(영소문, 숫자 포함 8~16자)">
							</div>
					...
					<div class="bottom_btn  ">
						<div class="form-row">
							<div class="col-12"><button type="button" class="btn btn-primary btn-block btn-lg" onclick="location.href='./find_pw_cmp.php'">완료</button></div>
						</div>
					</div>
			</form>
        </div>
