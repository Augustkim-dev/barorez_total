                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-6 col-lg-9">
                            <form method="POST" name="frm_search" id="frm_search" action="<?=$_SERVER['PHP_SELF'].'?'.$qstr?>" onsubmit="return frm_search_chk(this, event);" class="row d-flex justify-content-end align-items-center ">
                                <script type="text/javascript">
                                    ...
                                    document.addEventListener("DOMContentLoaded", function () {
                                      ...
                                      <?php if ($_POST['sel_search']) { ?>
                                        $('#sel_search').val('<?= $_POST['sel_search'] ?>').trigger('change');
                                      <?php } ?>
                                    });
                                ...
                                <div class="col-md-1 px-1">
                                  <select class="form-control" name="sel_search" id="sel_search" tabindex="-1" aria-hidden="true" style="width:100%;">
                                      <option value="all">통합검색</option>
                                      <option value="a1.rt_title">제목</option>
                                ...
                                <div class="col-md-4 px-1 d-flex">
                                  ...
                                  <button type="button" class="btn btn-info margin-right-5" onclick="location.href='./form.php<?php echo '?'.$qstr?>'">신규등록</button>
                                  <button type="button" class="btn btn-gray" onclick="location.href='./list.php<?php echo '?'.$qstr?>'">초기화</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <form name="frm_list" id="frm_list" onsubmit="return false;">
                        ...
                        <input type="hidden" name="obj_sel_domain" id="obj_sel_domain" value="<?=$_REQUEST['gubun']?>" />
