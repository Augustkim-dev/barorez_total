...
if ($_GET['act'] == "update") {
  ...
  $row = $DB->getone($CFG_TBL['board']['default'], '*, idx as nt_idx');

  // 첨부파일 정보 조회
  $DB->where('board', 'board');
              ...
              <h4 id="rw-fe-basic">게시글 <?=$_act_txt?></h4>
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-4 col-form-label">
                        <span><?=DateType($row['nt_wdate'], 6)?></span>
                    </div>
                </div>
                <div class="form-group row align-items-start">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="nt_show" id="nt_show" class="form-control">
                            <option value="Y" <?=$row['nt_show'] === 'Y' ? 'selected' : '' ?>>노출</option>
                            <option value="N" <?=$row['nt_show'] === 'N' ? 'selected' : '' ?>>비노출</option>
                        </select>
                        <?php } else{?>
                            <label for="mt_name" class="col-form-label d-block form-group"><?=$row['nt_show'] === 'Y' ? '노출' : '비노출'?></label>
                        <?php } ?>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        ...
                        <label for="mt_name" class="col-form-label d-block form-group"><?=$row['nt_hit']?></label>
                    </div>
                </div>
                ...
                <div class="form-group row margin-top-30" style="width:100%; height:400px; overflow:hidden;">
                    <iframe
                            src="https://utopiakorea.epicque.com/board_detail.php?id=<?=$_GET['nt_idx']?>"
                            width="100%"
                            height="500"
                            style="width:100%;
      height:500px;
