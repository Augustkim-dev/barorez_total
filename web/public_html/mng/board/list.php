            ...
            <div class="card margin-bottom-0">
                <div class="card-body">
                            ...
                            <form method="POST" name="frm_search" id="frm_search" action="<?=$_SERVER['PHP_SELF']?>?type=<?=urlencode($_GET['type'])?>" onsubmit="return frm_search_chk(this, event);" class="row justify-content-between">
                                <div class="d-flex justify-content-between align-items-center col-12">
                                    <div class="d-flex justify-content-start align-items-center">
                                        <label for="date" class="col-form-label mr-2" style="min-width: 60px"><?=$type['key'] === 2 ? '등록일' : '삭제일'?></label>
                                ...
                                <div class="d-flex justify-content-between align-items-center col-12">
                                    <div class="d-flex justify-content-start align-items-center mt-2">
                                        <label for="search_singo" class="col-form-label mr-2" style="min-width: 60px">구분</label>
                                        <select class="form-control" name="sel_category" id="sel_category" tabindex="-1" aria-hidden="true">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        <? if($_POST['sel_category']) { ?>$('#sel_category').val('<?=$_POST['sel_category']?>');<? } ?>
                                    </script>
                                </div>
                            </form>
                        </div>
                    ...
                    <form name="frm_list" id="frm_list" onsubmit="return false;">
                        ...
                        <input type="hidden" name="obj_sel_category" id="obj_sel_category" value="<?=$_POST['sel_category']?>" />
