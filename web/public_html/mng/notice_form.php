...
if ($_GET['act'] == "update") {
    ...
    $row = $DB->getone('notice_t', '*, idx as nt_idx');
    ...
    <div class="content" id="content">
        ...
        <div class="container-fluid">
            <div class="card margin-bottom-0">
                <div class="card-body">
                    <form method="post" name="frm_form" id="frm_form" action="./notice_update.php" target="hidden_ifrm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <h4 id="rw-fe-basic">공지사항 <?=$_act_txt?></h4>
