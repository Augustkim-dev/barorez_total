...
$type_key = $_GET['type'] ?? '';
if (!isset($menu_map[$type_key])) {
    $type_key = '';
}
$type = $menu_map[$type_key];
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="col-12">
                        <form method="POST"
                              name="frm_search"
                              id="frm_search"
                              action="<?=$_SERVER['PHP_SELF']?><?=$type_key ? '?type='.urlencode($type_key) : ''?>"
                              onsubmit="return frm_search_chk(this, event);"
                              class="row justify-content-between">

                            <?php if ($type_key !== 'secession') { ?>
                                <?php if ($type_key === 'approval') { ?>
                                    <!-- 승인관리: 회원 상태 -->
                                    <div class="d-flex justify-content-between align-items-center col-12 mb-2">
                                        <div class="d-flex justify-content-start align-items-center">
                                            <label class="col-form-label mr-2" style="min-width: 60px">회원 상태</label>
                                            ...
                                            <?php foreach($arr_approval_status as $key => $value) {
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center col-12 mb-2">
                                        <div class="d-flex justify-content-start align-items-center">
                                            <label class="col-form-label mr-2" style="min-width: 60px">회원 유형</label>
                                            <?php
                            ...
                            <div class="d-flex justify-content-between align-items-center col-12">
                                ...
                                <div class="d-flex justify-content-start align-items-center mt-2">
                                    ...
                                    <button type="button"
                                            class="btn btn-gray"
                                            onclick="location.href='./list.php?type=<?=urlencode($type_key)?>'">
                                        초기화
                                    </button>
                                </div>
                            </div>
                ...
                <script>
                    ...
                    function f_excel_down() {
                        ...
                        hidden_ifrm.document.location.href = `./excel_down.php?${query}`;
