            ...
            <div class="card margin-bottom-0">
                <div class="card-body">
                    <form method="POST" name="frm_list" id="frm_list" action="<?=$_SERVER['PHP_SELF']?>" onsubmit="return frm_search_chk(this, event);">
                        ...
                        <input type="hidden" name="sel_lv" id="obj_sel_lv" value="<?=$_GET['sel_lv']?>" />
                        <div class="form-row">
                            ...
                            <div class="col-6 col-lg-9 d-flex justify-content-end align-items-center">
                                ...
                                <select class="form-control searchByStatus" name="sel_search" id="sel_search" tabindex="-1" aria-hidden="true">
                                    ...
                                    <option value="a1.mt_hp">휴대폰번호</option>
                                    <option value="a1.mt_email">E-mail</option>
                                </select>
                                ...
                                <button type="button" class="btn btn-gray" onclick="location.href='./member_list.php?sel_lv=<?=$_GET['sel_lv']?>'">초기화</button>
                            </div>
                        </div>
                    </form>
