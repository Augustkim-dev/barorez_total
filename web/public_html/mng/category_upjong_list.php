    ...
    <div class="content" id="content">
        ...
        <div class="container-fluid">
            <div class="card margin-bottom-0">
                <div class="card-body">
                    <form method="POST" name="frm_search" id="frm_search" action="<?=$_SERVER['PHP_SELF']?>" onsubmit="return frm_search_chk(this);">
                        <div class="form-row">
                            ...
                            <div class="col-6 col-lg-9 d-flex justify-content-end align-items-center">
                                ...
                                <select class="form-control searchByStatus" name="sel_search" id="sel_search" tabindex="-1" aria-hidden="true">
                                    ...
                                    <option value="a1.ct_name">분류명</option>
                                </select>
                                ...
                                <button type="button" class="btn btn-info margin-right-5" onclick="location.href='./category_upjong_form.php'">신규등록</button>
                                <button type="button" class="btn btn-gray" onclick="location.href='./category_upjong_list.php'">초기화</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <form name="frm_list" id="frm_list" onsubmit="return false;">
                        ...
                        <input type="hidden" name="obj_uri" id="obj_uri" value="./category_upjong_update.php" />
                    ...
                    <script>
                        ...
                        $(document).ready(function() {
                            ...
                            // 이벤트 위임을 사용하여 동적 요소에 대한 이벤트 처리
                            $(document).on('change', '.switch input[name="ct_show"]', function() {
                                var $this = $(this);
                                var ct_idx = $this.closest('tr').data('id');

                                // ct_idx 값이 없는 경우 처리 중단
                                if(!ct_idx) {
                                    toastr.error('카테고리 정보를 찾을 수 없습니다.');
...
*/
                        ...
                        $(document).ready(function() {
                            ...
                            // 카테고리 토글 이벤트 초기화
                            initToggleHandler(
                                '.switch input[name="ct_show"]',  // 셀렉터
                                'id',                             // data 속성 이름
                                './category_upjong_update.php'    // 업데이트 URL
                            );
                        });
                    </script>
                </div>
