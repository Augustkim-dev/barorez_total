                    ...
                    <form method="post" name="frm_form" id="frm_form" action="./update.php" target="hidden_ifrm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row margin-top-30">
                              <label for="ct_title" class="col-sm-2 col-form-label">신고 사유</label>
                              <div class="col-sm-10">
                                <input type="text" name="w_name" id="w_name" value="<?=$row['w_name']?>" class="form-control">
                              </div>
                            </div>
<!--                            <div class="form-group row margin-top-30">-->
<!--                              <label for="ct_title" class="col-sm-2 col-form-label">영문이름</label>-->
<!--                              <div class="col-sm-10">-->
<!--                                <input type="text" name="w_name_en" id="w_name_en" value="--><?php //=$row['w_name_en']?><!--" class="form-control">-->
<!--                              </div>-->
<!--                            </div>-->
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <select name="w_show" id="w_show" class="form-control select-simple">
                                  <option value="Y" <?=$row['w_show'] === 'Y' ? 'selected' : '' ?>>사용</option>
                                  <option value="N" <?=$row['w_show'] === 'N' ? 'selected' : '' ?>>미사용</option>
                                </select>
                              </div>
                            </div>
