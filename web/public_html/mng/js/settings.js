...
var settings = {    
    ...
    vars: {
        ...
        s_nav_custom:    document.getElementById("rw_settings_nav_custom"),
    ...
    add_events: function(){
        ...
        // custom
        settings.vars.s_nav_custom.addEventListener("change",function(e){
            if(e.target.checked){
                settings.vars.page_aside_navigation.classList.add("navigation--custom");
            }else{                
                settings.vars.page_aside_navigation.classList.remove("navigation--custom");
            }            
        });
    ...
    detect_states: function(){
        ...
        if(settings.vars.page_aside){            
            ...
            settings.vars.s_nav_custom.checked = settings.vars.page_aside_navigation.classList.contains("navigation--custom") ? true : false;
