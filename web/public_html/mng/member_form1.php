                        ...
                        <div class="tab-pane fade show active" id="member-1" role="tabpanel" aria-labelledby="member-tab-1">
                            ...
                            <? if($_act=='input'){?>
                                <div class="form-group row">
                                    <label for="mt_type" class="col-sm-2 col-form-label">회원구분</label>
                                    <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <p class="form-inline">
                                        <input type="text" class="form-control" name="mt_zip" id="mt_zip" value="" style="width:100px;" placeholder="" readonly="">
                                    ...
                                    <p>
                                        <input type="text" class="form-control" name="mt_add1" id="mt_add1" value="" placeholder="" readonly="">
                                    </p>
                                    <p>
                                        <input type="text" class="form-control" name="mt_add2" id="mt_add2" value="" placeholder="">
                                    </p>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <? if($_act=='update'){?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <p class="form-inline">
                                            ...
                                            <input type="text" class="form-control" name="mt_nickname" id="mt_nickname" value=""  placeholder="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="upload-container">
                                            <div class="upload-box" id="uploadTrigger1"
                                                 data-existing-image="<?php echo !empty($row['mt_image1']) ? $member_img_url.$row['mt_image1'] : ''; ?>">
                                                <div class="upload-content">
                                                    <div class="plus">+</div>
                                                    <div class="text">Upload</div>
                                                </div>
                                                <button type="button" class="remove-btn" onclick="imageUploader.removeImage('1')">×</button>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="member-3" role="tabpanel" aria-labelledby="member-tab-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="mt_pushing1" class="col-sm-2 col-form-label">푸시알림</label>
                                    <div class="col-sm-4">
                            ...
                            if($seller_info || $agency_info) {
                                ...
                                <div class="tab-pane fade" id="member-5" role="tabpanel" aria-labelledby="member-tab-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="upload-container">
                                                <div class="upload-box" id="uploadSrtTrigger1"
                                                     data-existing-image="<?php echo !empty($row['srt_image1']) ? $member_img_url.$row['srt_image1'] : ''; ?>">
                                                    <div class="upload-content">
                                                        <div class="plus">+</div>
                                                        <div class="text">Upload</div>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="member-6" role="tabpanel" aria-labelledby="member-tab-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="agy_content" id="agy_content" value="<?=$row_srt['agy_content']?>" class="form-control" placeholder="" />
                                        </div>
                                    </div>
                                </div>
                            <? } ?>
