...
if ($_POST['act'] == "input") {
    ...
    $list = $DB->arraybuilder()->paginate("notice_t a1", $pg, '*, idx as nt_idx');
            ...
            if ($list) {
                ...
                <tr draggable="true" data-id="<?=$row['idx']?>">
                    ...
                    <td data-title="관리" class="text-center">
                        ...
                        <input type="button" class="btn btn-outline-danger btn-sm" value="삭제" onclick="f_post_del('./notice_update.php', '<?=$row['nt_idx']?>');" />
                    </td>
                    <td data-title="제목">
