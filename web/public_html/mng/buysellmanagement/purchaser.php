            ...
            <div class="tab-content margin-top-15">
              <div class="tab-pane fade show active" id="step-1" role="tabpanel" aria-labelledby="step-tab-1">
                ...
                <div class="form-group row margin-top-30">
                  ...
                  <div class="col-sm-4 form-validate">
                    ...
                    $value = (isset($saleInfo['gmt_sale_price']) && $saleInfo['gmt_sale_price'] !== null)
                      ? number_format($saleInfo['gmt_sale_price'])
                      : 0;
                    ?>
                ...
                <div class="form-group row margin-top-30">
                  ...
                  <div class="col-sm-4 form-validate">
                    <input type="text" name="gmtt_status" id="gmtt_status"
                           value="<?= $arr_gmtt_status[$row['gmtt_status']] ?>" class="form-control" disabled>
                  </div>
                ...
                <div class="form-group row margin-top-30">
                  <label for="mt_conclusion_name" class="col-sm-2 col-form-label">고객명 <span class="text-danger">*</span></label>
                  <div class="col-sm-4 form-validate">
                    <input type="text" name="mt_conclusion_name" id="mt_conclusion_name" value="" placeholder="고객명 입력"
                           class="form-control">
                  </div>
                  <label for="mt_conclusion_hp" class="col-sm-2 col-form-label">전화번호 <span class="text-danger">*</span></label>
                  <div class="col-sm-4 form-validate">
                    <input type="text" name="mt_conclusion_hp" id="mt_conclusion_hp" value="" placeholder="숫자만 입력"
                           class="form-control">
                  </div>
                </div>

                <div class="form-group row margin-top-30">
                  <label for="gmtt_conclusion_type" class="col-sm-2 col-form-label">구분 <span class="text-danger">*</span></label>
                  <div class="col-sm-10 form-validate">
                    <select name="gmtt_conclusion_type" id="gmtt_conclusion_type" class="form-control select-simple">
                  ...
                  const formHandler = {
                      ...
                      initializeValidation() {
                          $("#frm_form").validate({
                              ...
                              rules: {
                                  mt_conclusion_name: {required: true},
                                  mt_conclusion_hp: {required: true},
                                  gmtt_conclusion_type: {required: true},
                              },
                              messages: {
                                  mt_conclusion_name: {required: '체결자명은 필수등록입니다.'},
                                  mt_conclusion_hp: {required: '체결희망자 전화번호는 필수등록입니다.'},
                                  gmtt_conclusion_type: {required: '체결구분은 필수등록입니다.'},
