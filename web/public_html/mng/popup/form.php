...
if ($_GET['act'] == "update") {
    ...
    $row = $DB->getone($CFG_TBL['popup']['default'], '*, idx as nt_idx');
            ...
            <div class="card margin-bottom-0">
                <div class="card-body">
                    <form method="post" name="frm_form" id="frm_form" action="./update.php" target="hidden_ifrm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <h4 id="rw-fe-basic">팝업 <?=$_act_txt?></h4>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="form-group row margin-top-30">
                              <label for="rt_link_url" class="col-sm-2 col-form-label">링크 URL</label>
                              <div class="col-sm-10">
                                <input type="text" name="rt_link_url" id="rt_link_url" value="<?=$row['rt_link_url']?>" class="form-control">
                              </div>
                            </div>
