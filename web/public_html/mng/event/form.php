...
if ($_GET['act'] == "update") {
    ...
    $row = $DB->getone($CFG_TBL['event']['default'], '*, idx as nt_idx');
            ...
            <div class="card margin-bottom-0">
                <div class="card-body">
                    <form method="post" name="frm_form" id="frm_form" action="./update.php" target="hidden_ifrm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <h4 id="rw-fe-basic">이벤트 <?=$_act_txt?></h4>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <select name="rt_show" id="rt_show" class="form-control">
                            ...
                            <div class="form-group row d-none">
                              ...
                              <div class="offset-sm-2">
                                <small class="form-text">최대 권장사이즈 - 가로:536px, 세로:110px </small>
                              </div>
                            </div>
                            ...
                            <? if ($_GET['act'] == "update") {?>
                              <div class="form-group row">
                                <label for="created_at" class="col-md-2 col-form-label">상태</label>
                                <div class="col-md-10">

                                  <select name="rt_status" id="rt_status" class="form-control" disabled>
                                    <option value="">선택하세요.</option>
                                    <?php
                                    foreach($arr_event_type as $key=>$value) {
