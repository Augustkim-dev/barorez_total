...
if ($_POST['act'] == "input") {
  ...
  try {
    ...
    // 공지사항 삭제
    $DB->where('idx', $_POST['idx']);
    $DB->delete($CFG_TBL['notice']['default']);
...
<!--            </td>-->
            ...
            <td data-title="관리" class="text-center">
              ...
              <input type="button" class="btn btn-outline-danger btn-sm" value="복구" onclick="f_post_del('./update.php', '<?=$row['nt_idx']?>');" />
            </td>
              <td data-title="아이디">
