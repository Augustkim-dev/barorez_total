...
echo "<!-- pre $search_status>";
print_r($_POST);
echo "</pre --!>";

$sdate = $_POST['sdate'] ?? date('Y-m-d', time());
$edate = $_POST['edate'] ?? date('Y-m-d', time());
?>
            ...
            <div class="card margin-bottom-0">
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-12">
                            <form method="POST" name="frm_search" id="frm_search" action="<?=$_SERVER['PHP_SELF']?>" onsubmit="return frm_search_chk(this, event);" class="row">

                                <div class="col-md-6 d-flex justify-content-start align-items-center">
                                  <label for="sdate" class="col-sm-2 col-form-label">신고일</label>
                                  <input type="date" class="col-sm-2 form-control" name="sdate" id="sdate" value="<?=$sdate?>" />
                                  <label for="edate" class="col-sm-1 text-center">~</label>
                                  <input type="date" class="col-sm-2 form-control " name="edate" id="edate" value="<?=$edate?>" />
                                </div>
                                <div class="col-md-6 d-flex justify-content-start align-items-center">
                                  ...
                                  <select class="form-control searchByStatus" name="sel_search" id="sel_search" tabindex="-1" aria-hidden="true">
                                    ...
                                    <option value="a2.rvt_content">내용</option>
                                  </select>
                                ...
                                <div class="col-md-6 d-flex justify-content-start align-items-center mt-2">
                                  <label for="search_singo" class="col-sm-2 col-form-label">처리상태</label>
                                    ...
                                    ?>
                                    <button type="button" data-local="all" class="margin-right-5 local-search-btn btn <?php echo $local_total_class_name?>">
                                      전체
                                    </button>
                                ...
                                <div class="col-md-6 d-flex justify-content-start align-items-center mt-2 ">
                                  <label for="search_singo" class="col-sm-2 col-form-label">신고사유</label>
                                  <select name="search_singo" id="search_singo" class="form-control search_singo">
                                    <option value="all">선택하세요.</option>
                                    <?php
                                    foreach($arr_stype as $key=>$value) {
                                      $selected = ($_POST['search_singo'] == $key) ? 'selected' : '';
                  ...
                  <script type="text/javascript">
                    ...
                    <form name="frm_list" id="frm_list" onsubmit="return false;">
                        ...
                        <input type="hidden" name="obj_search_status" id="obj_search_status" value="<?=$_POST['search_status'] ?? 'all'?>" />
                        <input type="hidden" name="obj_search_sdate" id="obj_search_sdate" value="<?=$sdate?>" />
                        <input type="hidden" name="obj_search_edate" id="obj_search_edate" value="<?=$edate?>" />
                        <input type="hidden" name="obj_search_singo" id="obj_search_singo" value="<?=$_POST['search_singo'] ?? 'all'?>" />
                    </form>
