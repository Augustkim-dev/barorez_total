...
if ($_GET['act'] == "view") {
    ...
    $reply = $DB->getone($CFG_TBL['reply']['default']);
    ...
    $reply_mt_id = $reply['mt_id'];
    $reply_rt_wdate = DateType($reply['rt_wdate'], 4);
    $reply_rvt_content = $reply['rvt_content'];
    if($reply['rt_del']=='Y'){
      $reply_mt_id = '-';
      $reply_rt_wdate = '-';
      $reply_rvt_content = '삭제된 댓글입니다.';
    }
                        ...
                        <div class="tab-content margin-top-15">
                          <div class="tab-pane fade show active" id="step-1" role="tabpanel" aria-labelledby="step-tab-1">
                            ...
                            <div class="form-group row margin-top-30">
                              ...
                              <div class="col-sm-4">
                                <input type="text" name="mt_id" id="mt_id" value="<?=$reply_mt_id?>" class="form-control" <?=$isDsiabled?> />
                              </div>
                              <label for="rt_wdate" class="col-sm-2 col-form-label">작성일</label>
                              <div class="col-sm-4">
                                <input type="text" name="rt_wdate" id="rt_wdate" value="<?=$reply_rt_wdate?>" class="form-control" <?=$isDsiabled?> />
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="rvt_content" class="col-sm-2 col-form-label">내용</label>
                              <div class="col-sm-10">
                                <input type="text" name="rvt_content" id="rvt_content" value="<?=$reply_rvt_content?>" class="form-control" <?=$isDsiabled?> />
                              </div>
                            </div>
