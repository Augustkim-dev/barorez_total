                        ...
                        <form method="POST" name="frm_search" id="frm_search" action="<?=$_SERVER['PHP_SELF']?>" onsubmit="return frm_search_chk(this, event);" class="row justify-content-between">
                            ...
                            <div class="d-flex justify-content-between align-items-center col-12">
                                <div class="d-flex justify-content-start align-items-center mt-2">
                                    <label for="search_status" class="col-form-label mr-2" style="min-width: 60px">구분</label>
                                    <select class="form-control" name="search_status" id="search_status" tabindex="-1" aria-hidden="true">
                                        <option value="">회원유형</option>
                                        <option value="최고관리자">최고관리자</option>
                                        <option value="중간관리자">중간관리자</option>
                                        <option value="폴리스관리자">폴리스관리자</option>
                            ...
                            <script type="text/javascript">
                                ...
                                <? if($_POST['search_status']) { ?>$('#search_status').val('<?=$_POST['search_status']?>');<? } ?>
                            </script>
                        </form>
                    </div>
                </div>
