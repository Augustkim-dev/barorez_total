    ...
    <div class="sub_pg pl-0 ">
        <div class="join_form_wr">
            ...
            <div class="join_form text-center">
                <img src="<?=DESIGN_HTTP?>/market/img/login_img.png" alt=" " class="mt-5">
                ...
                <div class="text-center mt_50">
                    <button type="button" class="btn btn-primary btn-lg btn-w1" onclick="location.replace('./login.php')">확인</button>
                </div>
