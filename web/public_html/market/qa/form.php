...
$chk_menu     = 99; // 메뉴 번호는 프로젝트에 맞게 조정
$chk_sub_menu = 2;
...
?>
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="./list.php" class="btn btn-outline-secondary">목록</a>
            </div>
        </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <?php foreach ($images as $img): ?>
                                ...
                                $thumb = 'rs_' . $orig;
                                ?>
                                <a href="<?= $qa_upload_url . '/' . $orig ?>" target="_blank">
                                    <img src="<?= $qa_upload_url . '/' . $thumb ?>"
                                         alt=""
                                         class="img-thumbnail"
            ...
            <div class="card-body">
                <form id="qaAnswerForm">
                    ...
                    <textarea name="rt_response_text"
                              class="form-control"
                              rows="8"
                              placeholder="답변 내용을 입력해주세요." readonly><?= h($row['rt_response_text']) ?></textarea>
                    </div>
